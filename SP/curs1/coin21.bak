...
(define (first-denomination kind-of-coins)
  (cond ((= kind-of-coins 1) 1)
        (else (cond ((= kind-of-coins 2) 3)
                   (else (cond ((= kind-of-coins 3) 15)
                               (else(cond ((= kind-of-coins 4) 20)
                                          (else (cond ((= kind-of-coins 5) 25)
                                                     (else (cond ((= kind-of-coins 6) 50)
                                                                (else 0))))))))))))
)
...
(define (denomination-list kinds-of-coins)
  (cond ((= kinds-of-coins 0) (newline))(else
  (cond ((= kinds-of-coins 0) 0)
